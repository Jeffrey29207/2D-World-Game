...
public class Tileset {
    ...
    public static final TETile AVATAR2 = new TETile('█', Color.white, Color.black, "you", 0);
    public static final TETile AVATAR3 = new TETile('█', Color.orange, Color.black, "you", 0);
    public static final TETile AVATAR4 = new TETile('█', Color.yellow, Color.black, "you", 0);
    ...
    public static final TETile SNOW = new TETile('☃', Color.white, Color.black, "snowman", 13);
    public static final TETile ENEMY = new TETile('☠', Color.white, Color.black, "enemy", 13);
}
